...
export class AppComponent {
  ...
  rowSelectingClick(RowSelectingtArgs: any) {
    ...
    if (RowSelectingtArgs.target != null) {
      if (RowSelectingtArgs.target.classList == "e-frame e-icons") {
        ...
        $(".e-treegrid td.e-active").css.backgroundColor = "pink";
        alert("Working");
  ...
  batchSave(e: any) {
    var data = {
      action: "batch",
      Changed: e.batchChanges.changedRecords,
      Added: e.batchChanges.addedRecords,
      Deleted: e.batchChanges.deletedRecords,
    };
    var ajax: any = new ajax();
